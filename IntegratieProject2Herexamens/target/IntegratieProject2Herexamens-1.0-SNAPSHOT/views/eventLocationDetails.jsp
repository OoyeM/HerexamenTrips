            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a  href="<c:url value='/events/${eventId}' />"> Event: ${eventId}</a>
                        </li>
                        <li>
                            <a  href="<c:url value='/events/event/${eventId}/${tripLocation.trip.tripId}' />"> Trip: ${tripLocation.trip.tripId}</a>
                        </li>
                        <li>
                            Triplocation: ${tripLocation.locationId}
                        </li>
                        <li>
                            <a href="<c:url value='/events/event/${eventId}/${tripLocation.trip.tripId}'/>"><button type="button" class="btn"><span class="glyphicon glyphicon-fast-backward" aria-hidden="true"></span>  Back</button></a>
                        </li>
                    </ol>
                </div>
            </div>

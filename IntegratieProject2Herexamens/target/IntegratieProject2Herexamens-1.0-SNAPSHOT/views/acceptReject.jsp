        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-dashboard"></i> Edit invitation
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <a href="<c:url value='/myEvents/alter/${eventId}/acceptInvite/${pageContext.request.userPrincipal.name}/true' />">
                        <button type="button" class="btn btn-success">Accept</button>
                    </a>
                    <a href="<c:url value='/myEvents/alter/${eventId}/acceptInvite/${pageContext.request.userPrincipal.name}/false' />">

            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form class="navbar-form navbar-right" role="search"
                          action="${pageContext.request.contextPath}/trips" method="GET">
                ...
                <div class="col-lg-12">
                        ...
                        <table data-toggle="table" data-click-to-select="true">
                            ...
                            <c:forEach items="${trips}" var="trip">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value='/trip/${trip.tripId}' />">${fn:substring(trip.description,0,100)}</a>
                                    </td>
                                    <td><a href="<c:url value='/trip/${trip.tripId}' />">${trip.createdBy.username}</a>
                                    </td>
                    ...
                    <div>
                        <tag:paginate limit="${limit}" offset="${offset}" count="${count}"
                                      uri="${pageContext.request.contextPath}/trips"
